...
await conn.sendMessage(m.chat, {text: loadd[i], edit: key })}
  ...
  await conn.reply(m.chat, `┌✦ *⚕️My Premium Time⚕️*
┊• *👤Nama:* ${ryhar.registered ? ryhar.name : conn.getName(m.sender)}
...
function clockString(ms) {
  ...
  return ['┊ ', ye, ' *Tahun*\n', '┊ ', mo, ' *Bulan*\n', '┊ ', d, ' *Hari*\n', '┊ ', h, ' *Jam* ', m, ' *Menit* ', s, ' *Detik*'].map(v => v.toString().padStart(2, 0)).join('')
}
