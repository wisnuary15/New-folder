  ...
  return list[Math.floor(list.length * Math.random())]
		...
		global.adReply = {
			contextInfo: {
				...
				externalAdReply: {
					...
					title: '',
					body: 'ꜰᴜʀɪɴᴀ ᴏɴʟʏ ᴏɴᴇ', 
					mediaUrl: sgc,
					description: 'ꜰᴜʀɪɴᴀ ᴏɴʟʏ ᴏɴᴇ', 
					previewType: "PHOTO",
	...
	key : {
       ...
       message: {
                    locationMessage: {
                    name: 'Japan`s',
                    jpegThumbnail: fs.readFileSync('./media/furina.jpg')
                          }
                        }
                      }
		global.fpayment = {
...
global.fakefb = {
         contextInfo: { externalAdReply: { showAdAttribution: true,
            ...
            mediaType: "VIDEO",
            description: "https://www.instagram.com/genkaku._", 
            title: wm3,
            body: wm,
            thumbnailUrl: pp,
            sourceUrl: sgc
		...
		global.fkontak = { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: `status@broadcast` } : {}) }, message: { 'contactMessage': { 'displayName': wm, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;${wm},;;;\nFN:${wm},\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabell:Ponsel\nEND:VCARD`, 'jpegThumbnail': fs.readFileSync('./media/furina.jpg'), thumbnail: fs.readFileSync('./media/furina.jpg'),sendEphemeral: true}}}
        global.fvn = {
            key: { 
                 fromMe: false,
            ...
            message: { "liveLocationMessage": { "caption":"Made By: " + global.nameown ,"h": `${wm}`, 'jpegThumbnail': fs.readFileSync('./media/furina.jpg')}}
           }
            ...
            participant: `0@s.whatsapp.net`, ...(m.chat ? 
            { remoteJid: "status@broadcast" } : {}) },
            message: { "liveLocationMessage": { "title": "ꜱʜɪQɪᴏɴʟʏᴏɴᴇ","h": wm, 'jpegThumbnail': fs.readFileSync('./media/furina.jpg')}}
           }
               ...
               message: {
                   "productMessage": {
                       "product": {
                           "productImage":{
                               "mimetype": "image/jpeg",
                               "jpegThumbnail": fs.readFileSync('./media/furina.jpg') //Gambarnye
                           },
